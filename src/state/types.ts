...
export const STORY_FLAGS = [
  ...
  'choir-filter-overexposed',
  'choir-navigation-compromised',
  'scylla-close-course',
  'charybdis-wide-course',
  'scylla-rescue-attempted',
  'all-six-rescued',
  'scylla-partial-rescue',
  'six-abandoned',
  'helios-warning-understood',
  'helios-ecology-mapped',
  'helios-ethical-recharge',
  'helios-life-consumed',
  'helios-remnant-preserved',
  'mutiny-forgiven',
  'mutiny-condemned',
  'last-companion-record-preserved',
