...
const SCENES = {
  ...
  'b6-memories': {
    id: 'b6-dead-in-first-person', beat: 'BEAT 06', chapter: 'THE FIRST WRATH', title: 'The dead speak in first person', location: 'BRIDGE MEMORY FIELD · NO SAFE DISCONNECT', sceneType: 'memory', background: ASSETS.cinematics.tidefatherIntercept,
    lines: [
      { speaker: 'narrator', name: 'MEMORY INTRUSION', cue: 'SOURCE · TIDE GATE SANCTUARY', text: 'The bridge is gone. There is warmth. Pressure. Another life turning toward Vale before either of them has a name. Then white fire.', cutaway: { image: ASSETS.cinematics.tidefatherIntercept, label: 'INTRUSIVE MEMORY', caption: 'The faces are an interface built from the crew’s own dead.' }, pause: 'held', shot: 'wide' },
      { speaker: 'isabella-corelli', name: 'CORELLI', station: 'MEDICAL', text: 'Six seconds. Your heart. Mine too.', emotion: 'exhausted', shot: 'close' },
      { speaker: 'helen-morozova', name: 'MOROZOVA', station: 'SCIENCE', text: 'The signals weren’t stored there. They were becoming there.', emotion: 'angry', reaction: { speaker: 'gabriel-cross', name: 'CROSS', emotion: 'wounded' } },
      { speaker: 'gabriel-cross', name: 'CROSS', station: 'SECURITY', text: 'And the fleet behind it?', emotion: 'wounded' },
      { speaker: 'tidefather', name: 'THE TIDEFATHER', station: 'EIDOLON HOST', text: 'You made them targets before they were made themselves. I had already learned the warmth of each one.', pause: 'silence', shot: 'close' },
      { speaker: 'alexander-vale', name: 'VALE', station: 'COMMAND', text: 'Why the whole crew?', emotion: 'grieving' },
      { speaker: 'tidefather', name: 'THE TIDEFATHER', station: 'EIDOLON HOST', text: 'They carry your going-home inside them. Now it carries us too.' },
    ],
    moments: [{ id: 'after-cradle-memory', afterLine: 4, prompt: 'The memory remains open. Vale has time for one human response before the confrontation continues.', choices: [
      { id: 'check-kiara', label: 'Ask Kiara if it is hurting her', detail: 'Notice the translator before treating the signal as a tactical object.', character: 'kiara-ndala', axis: 'intimacy', delta: 1, response: { speaker: 'kiara-ndala', name: 'N’DALA', station: 'COMMUNICATIONS', text: 'Yes. Don’t cut it. Just—don’t call it a message yet.', emotion: 'frightened', pause: 'short', shot: 'close' } },
      { id: 'keep-cross-aimed', label: 'Keep Cross on the target', detail: 'Protect the bridge while allowing the memory to remain audible.', character: 'gabriel-cross', axis: 'respect', delta: 1, response: { speaker: 'gabriel-cross', name: 'CROSS', station: 'WEAPONS', text: 'Still on it. Not firing.', emotion: 'wounded', reaction: { speaker: 'helen-morozova', name: 'MOROZOVA', emotion: 'guarded' } } },
      { id: 'stay-in-memory', label: 'Stay with the memory', detail: 'Do not reach for a crew member or an order; let the dead keep the silence.', character: 'helen-morozova', axis: 'trust', delta: 1, response: { speaker: 'narrator', name: 'BRIDGE RECORD', text: 'Vale leaves both hands open on the arms of the command chair.', pause: 'silence', shot: 'wide' } },
    ] }],
    choices: [
  ...
  'b8-judgment': {
    id: 'b8-first-mutiny', beat: 'BEAT 08', chapter: 'THE FORBIDDEN SPHERE', title: 'The first mutiny has a face', location: 'CONTAINMENT DECK · SHIPWIDE CHANNEL CLOSED', sceneType: 'confrontation', background: ASSETS.cinematics.sphereRupture,
    lines: [
      ...
      { speaker: 'isabella-corelli', name: 'CORELLI', station: 'MEDICAL', text: 'They thought the officers had their own way home. Wrong, yes. Mad? No.', emotion: 'exhausted' },
      { speaker: 'helen-morozova', name: 'MOROZOVA', station: 'EXECUTIVE OFFICER', text: 'We sealed a door and expected trust to grow outside it.', emotion: 'angry' },
      { speaker: 'gabriel-cross', name: 'CROSS', station: 'SECURITY', text: 'I can understand Venn or keep this ship alive. Right now I need a rule.', emotion: 'wounded' },
      { speaker: 'elias', name: 'ELIAS', station: 'SHIP SERVICE INTELLIGENCE', text: 'They are listening for the word “they,” Captain.' },
      { speaker: 'alexander-vale', name: 'VALE', station: 'COMMAND', text: 'Open the channel.', pause: 'held' },
    ],
    moments: [{ id: 'hear-mara-venn', afterLine: 4, prompt: 'The person who opened the sphere is behind the bulkhead. Hear her, or decide without her.', choices: [
      { id: 'bring-venn-in', label: 'Let Venn speak', detail: 'Give the mutiny a human voice before deciding what order requires.', character: 'isabella-corelli', axis: 'respect', delta: 1, response: { speaker: 'narrator', name: 'PETTY OFFICER MARA VENN · INTERCOM', text: 'I thought you’d leave us. I was wrong about the door. Not about being afraid.', pause: 'held', shot: 'close' } },
      { id: 'ask-cross-for-rule', label: 'Ask Cross for the rule', detail: 'Force security to name the boundary it wants command to enforce.', character: 'gabriel-cross', axis: 'trust', delta: 1, response: { speaker: 'gabriel-cross', name: 'CROSS', station: 'SECURITY', text: 'Nobody gets to gamble the whole ship. Not crew. Not captain.', emotion: 'wounded' } },
      { id: 'keep-door-closed', label: 'Keep the door closed', detail: 'Preserve command distance; Venn will hear the sentence with everyone else.', character: 'isabella-corelli', axis: 'resentment', delta: 1, response: { speaker: 'narrator', name: 'CONTAINMENT DECK', text: 'Vale watches Venn’s shadow move behind the wired glass and does not open the door.', pause: 'silence', shot: 'reaction' } },
    ] }],
    choices: [
