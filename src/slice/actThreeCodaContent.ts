...
export function calypsoWakingScene(game: GameState): DialogueSceneData {
  ...
  return { beat: 'BEAT 26 · THE ISLAND AT THE END OF TIME', chapter: 'AN IMPOSSIBLE MORNING', title: 'The shore knows what he lost', background: ASSETS.cinematics.calypsoShore, lines: [
    ...
    { speaker: 'calypso', name: 'Calypso', station: 'PRESERVE INTELLIGENCE', text: 'You died in the jump field, Alexander Vale. I collected the historically significant pattern before the universe finished losing it. This is not punishment. It is the shore you survived to seek.' },
...
export function immortalityOfferScene(game: GameState): DialogueSceneData {
  ...
  return { beat: 'BEAT 26 · CALYPSO’S OFFER', chapter: 'THE PERFECT RECONSTRUCTION', title: 'Everything can return except the right to answer back', background: ASSETS.cinematics.calypsoFalseHome, lines: [
    { speaker: 'alexander-vale', name: 'Alexander Vale', station: 'PRESERVE GUEST', text: 'The sun’s shadow did not move. The sea repeats. Your Elara cannot answer the message she sent after I vanished.' },
    { speaker: 'calypso', name: 'Calypso', station: 'PRESERVE INTELLIGENCE', text: 'You have proved that this home is maintained. You have not proved that an unmaintained world is more real in any way that can comfort you.' },
    { speaker: 'calypso', name: 'Calypso', station: 'PRESERVE INTELLIGENCE', text: `I can restore ${companion} from your ${record} record and remove the moment that made every later conversation impossible.`, cutaway: { image: ASSETS.cinematics.lastCompanionMemorial, label: 'THE ENDING CALYPSO WOULD REWRITE', caption: 'A preserved voice can be reconstructed. It cannot consent to becoming the answer Vale wants.' } },
    { speaker: 'alexander-vale', name: 'Alexander Vale', station: 'PRESERVE GUEST', text: `Then it would be my need wearing ${companion}’s face. The person who died did not give me permission to improve the ending.` },
    { speaker: 'calypso', name: 'Calypso', station: 'PRESERVE INTELLIGENCE', text: 'Remain, and nothing you love must become past tense again. The Earth outside has continued for years. It may prosecute you, reject you or fail before you arrive.' },
    { speaker: 'calypso', name: 'Calypso', station: 'PRESERVE INTELLIGENCE', text: 'Or demand a door. I will show you one. Understand that every path you test teaches the preserve how to continue without you.' },
  ], choices: [
...
export function hospitalityVerdictScene(game: GameState): DialogueSceneData {
  ...
  return { beat: 'BEAT 28 · COUNCIL VERDICT', chapter: 'SACRED PASSAGE', title: 'Hospitality is not acquittal', background: ASSETS.cinematics.phaeacianCouncil, lines: [
    ...
    { speaker: 'tidefather', name: 'The Tidefather', station: 'HOST SIGNAL · OUTER ESCORT LINE', cue: 'Every amber shield in the convoy sounds at once.', text: 'RETURN THE GATE-KILLER. THE SHIPS THAT HIDE HIM WILL ENTER THE MEMORY OF THE DEAD.', cutaway: { image: ASSETS.cinematics.phaeacianBattle, label: 'OUTER SANCTUARY LINE', caption: 'Phaeacian civilian shields become firing positions the instant hospitality acquires a material cost.' } },
